...
public class LikeTimeline: Timeline {
    ...
    private static func animationsByLayer(view: LikeView, duration: TimeInterval) -> [CALayer: [CAKeyframeAnimation]] {
        ...
        animationsByLayer[view.heartGray.layer] = [path_heartGray, bounds_size_height_heartGray, bounds_size_width_heartGray, opacity_heartGray]
        animationsByLayer[view.plusIcon.layer] = [bounds_size_height_plusIcon, opacity_plusIcon, path_plusIcon, bounds_size_width_plusIcon]
